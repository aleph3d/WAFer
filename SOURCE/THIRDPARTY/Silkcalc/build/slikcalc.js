...
(function () {
	...
	slikcalc = {
		...
		create : function (type, config) {
			var calcs = {'column' : slikcalc.ColumnCalc, 'formula' : slikcalc.FormulaCalc};
			return calcs[type] ? new calcs[type](config) : null;
		}
...
(function () {
	...
	slikcalc.BaseCalc.prototype = {
		...
		/**
		 * @description Config object for this calculator
		 */
		config : null,
